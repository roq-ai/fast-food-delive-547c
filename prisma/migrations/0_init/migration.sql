...
-- AddForeignKey
ALTER TABLE "delivery_personnel" ADD CONSTRAINT "delivery_personnel_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION;
