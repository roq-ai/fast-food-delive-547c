...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Fast Food Delivery Services`}</title>

        <meta
          name="description"
          content="Welcome to Fast Food Delivery Services - Your gateway to intercity culinary delights. Order mouth-watering food and sweets online from iconic eateries and heritage shops."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Fast Food Delivery Services - Your gateway to intercity culinary delights. Order mouth-watering food and sweets online from iconic eateries and heritage shops.`}
            </Text>
            <Box
