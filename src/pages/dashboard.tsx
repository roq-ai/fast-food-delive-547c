...
import { DeliveryPersonnelListPage as ShowCaseList } from 'pages/delivery-personnels';
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                <Text as="b" fontSize="xl">
                  Latest Delivery Personnels
                </Text>
                <NextLink href={`delivery-personnels`} passHref legacyBehavior>
                  <Button
